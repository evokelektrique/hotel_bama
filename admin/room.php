...
<div class="content-body">
    ...
    <div class="row">
        ...
        <div class="col-12 mb-30">
            <div class="box">
                <div class="box-head">
                    <h3 class="title">ثبت کردن اتاق </h3>
                </div>
                <div class="box-body">
                        ...
                        <form action="../backend/function.php" method="post" enctype="multipart/form-data">
                            <div class="col-lg-12 col-12 mb-20">
                                ...
                                <div class="row mbn-15">
                                    <div class="col-12 mb-15"><input type="text" name="name" class="form-control" placeholder="ورودی"></div>

                                    <div class="col-12 mb-15"><h3 class="mb-15">تعداد نفر</h3>
                                        <input type="number" name="number_room" class="form-control" placeholder="چن نفره بودن اتاق"></div>
                                    <div class="col-12 mb-15"><h3 class="mb-15">قیمت</h3>
                                        <input type="number" name="price" class="form-control" placeholder="قیمت اتاق به ازا روز"></div>
                                    ...
                                    <div class="col-12 mb-15">
                                        ...
                                        <select class="form-control" name="category" required>
                                            ...
                                            <option value="master_room">اتاق ویژه</option>
                                            <option value="room_to">اتاق دو نفره</option>
                                            <option value="room_one">اتاق یک نفره</option>
                                            <option value="room_three">اتاق سه نفره</option>
                                            <option value="room_for">اتاق چهار نفره</option>
                                        </select>
                                    </div>
                            ...
                            <button class="button button-success" type="submit" name="submit_add_room"><span>ثبت</span></button>
                        </form>
                        <!--Form Field-->
